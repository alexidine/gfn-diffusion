...
from energy_sampling.eval.paper1_results.utils import cluster_dendro_fig, marginal_cluster_1d, coupling_ratio, \
    ...
    compute_dim_weights, estimate_logp_with_convergence, sample_from_gfn, analyze_samples, cluster_hdbscan_to_df
...
if __name__ == '__main__':
    ...
    maskes = [clust_labels == ind for ind in np.unique(clust_labels)]
