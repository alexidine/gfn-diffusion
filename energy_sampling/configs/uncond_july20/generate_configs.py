"""
uncond_july20 -- unconditional toy_2harm battery on the current protocol.py stage
system (base.yaml = mk_dev as of 2026-07-20 with cluster paths). Same sweep
structure as uncond_july17: architecture depth & width, off-diagonal (DPLR)
covariance, trajectory rollout length, and LR level.
